...
try:
    ...
    print("=" * 60)
    print("This usually means an authentication issue. Check:")
    print("1. ✅ API Key is set correctly in environment variables")
    print("2. ✅ API Secret is set correctly (complete, no truncation)")
    print("3. ✅ API Secret format: If multi-line, use \\n or actual newlines")
    print("4. ✅ API Key has 'View' and 'Trade' permissions in Coinbase")
    print("5. ✅ Using Coinbase Advanced Trade API (not legacy Pro)")
    print("\nCommon fixes:")
    print("- Re-enter API Secret in Railway (copy fresh from Coinbase)")
    print("- Ensure secret starts with '-----BEGIN EC PRIVATE KEY-----'")
    print("- Check Railway Variables tab - no extra quotes/spaces")
    print("- Test locally first: python main.py --test")
    print("\nSee RAILWAY_TROUBLESHOOTING.md for detailed help")
    print("=" * 60)
    if 'passphrase' in error_msg.lower() or 'password' in error_msg.lower():
